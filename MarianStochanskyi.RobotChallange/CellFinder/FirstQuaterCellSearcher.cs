...
{
    class FirstQuaterCellSearcher : BaseCellSearcher
    {
        public FirstQuaterCellSearcher(EnergyStation station, IList<Robot.Common.Robot> robots) : base(station, robots)
        {
        }
